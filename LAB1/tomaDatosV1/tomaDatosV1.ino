...
//            if (elapsedTime > tiempoDatos) {
//              arduinoPWM = arduinoPWM + 10; // PWMX60x80
//              tiempoDatos = tiempoDatos + 10500;
//            }


      //      if (elapsedTime == 3001) arduinoPWM = 10; // PWMX60x80
      //      if (elapsedTime == 3001) arduinoPWM = 15; // PWMX60x80
      //      if (elapsedTime == 3001) arduinoPWM = 20; // PWMX60xx80
      //      if (elapsedTime == 3001) arduinoPWM = 25; // PWMX60x80
      //      if (elapsedTime == 3001) arduinoPWM = 30; // PWMX60x80
      //      if (elapsedTime == 3001) arduinoPWM = 35; // PWMX60x80
      //      if (elapsedTime == 3001) arduinoPWM = 40; // PWMX60x80
      //      if (elapsedTime == 3001) arduinoPWM = 45; // PWMX60x80
      //      if (elapsedTime == 3001) arduinoPWM = 50; // PWMX60x80
      //      if (elapsedTime == 3001) arduinoPWM = 55; // PWMX60x80
      //      if (elapsedTime == 3001) arduinoPWM = 60; // PWMX60x80
      ...
      if (elapsedTime >= 66000 || arduinoPWM > 55 ) {
        autoincrement = false;
        startTime = 0; // Reiniciar el tiempo de inicio si autoincrement es false
        elapsedTime = 0;
        timeold = 0;
